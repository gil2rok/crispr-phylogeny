...
from .metrics import heracles_triplets_correct, dist_correlation
...
def init(char_matrix, mutation_rate, deletion_rate, transition_prob, 
    ...
    opt = RiemannianAdam([l.X], lr=lr, stabilize=stabilize)
...
def train(char_matrix, mutation_rate, deletion_rate, transition_prob, 
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        if true_tree is not None:
            log_metric('triplets correct', heracles_triplets_correct(true_tree, l.X, rho), step=epoch)
